...
subtitle: "Spring 2021, updated Spring 2026."
author: 
...
Here is a resource that Angela Petrone, a Spring 2023 Fellow, provided to the group: a Google document she called 'Master document' in which she kept track of all the research links and tasks she is carrying out and, most importantly, an *organized bibliography*. This will be super helpful in preparation of the final technical report, as the citations for the report need to be organized similarly. Here is a [link to document](TemplateSoReMoMasterDoc.docx) and [PDF version](TemplateSoReMoMasterDoc.pdf). 
...
Here is a good example of [one Fellow's Forum slides](PetroneForumFeb23.pdf); the starting point for these slides was a **Google slides template**: the template is under *Google Slides Templates > Work > Case study*. 
...
- **Academic readers** (for publication in the SoReMo Journal)  
...
**General rule:**  
- **Full technical detail → main body for journal publication**  
- **Simplified explanations → summaries or appendices for community versions**
...
For community‑facing versions, consider:
- Moving technical detail to an appendix  
