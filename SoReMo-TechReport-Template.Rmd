...
date: "Spring/Fall 20XX SoReMo Fellowship Project Final Technical Report"
output: 
  html_document:
    toc: true
    toc_depth: 2
...
This document is created by [Sonja Petrovic](www.sonjapetrovicstats.com) for [SoReMo](www.soremo.org) and is released under the same licence as the parent folder on Github. 
